...
package artistloc.songsdim_0_1;
...
/**
 * Job: SongsDim Purpose: Migrates Songs ID,Song Title,ArtistKey<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status DEV
 */
public class SongsDim implements TalendJob {
	static {System.setProperty("TalendJob.log", "SongsDim.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(SongsDim.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SongsDim";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_yNthUJ4fEe-wBqUbcMduCA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SongsDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:3Vo9KM0X6sT6j6VX7z+0pDOiL1N7T/PFZbll88LQ14L+").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:sQCDyET31SdZsNdCjy8jhiNs7+z9cRuvMuJab1vSAPaM");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:Gy1xPkCMpI7Ktqhm9PbJLyQLRHDJUFNA3qN1bk86X5WL").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:kuepDStLvaFjpSE0UVuy5YVkm4YKesSeKAvxz3fggDC/");
...
public static class Found1Struct implements routines.system.IPersistableRow<Found1Struct> {
    final static byte[] commonByteArrayLock_ARTISTLOC_SongsDim = new byte[0];
    static byte[] commonByteArray_ARTISTLOC_SongsDim = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARTISTLOC_SongsDim.length) {
				if(length < 1024 && commonByteArray_ARTISTLOC_SongsDim.length == 0) {
   					commonByteArray_ARTISTLOC_SongsDim = new byte[1024];
				} else {
   					commonByteArray_ARTISTLOC_SongsDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARTISTLOC_SongsDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_SongsDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARTISTLOC_SongsDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_SongsDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARTISTLOC_SongsDim) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.songid = dis.readInt();
					
					this.songtitle = readString(dis);
					
						this.songduration = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.songid);
					
					// String
				
						writeString(this.songtitle,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.songduration);
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ARTISTLOC_SongsDim = new byte[0];
			    ...
			    public BigDecimal song_duration;

				public BigDecimal getSong_duration () {
					return this.song_duration;
				}
				
			    public int song_release_year;

				public int getSong_release_year () {
					return this.song_release_year;
				}
		...
		synchronized(commonByteArrayLock_ARTISTLOC_SongsDim) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.song_title = readString(dis);
					
					this.artist_id = readString(dis);
					
						this.song_duration = (BigDecimal) dis.readObject();
					
			        this.song_release_year = dis.readInt();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.song_title,dos);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.song_duration);
					
					// int
				
		            	dos.writeInt(this.song_release_year);
    ...
    public String toString() {
		...
		sb.append(",song_title="+song_title);
		sb.append(",artist_id="+artist_id);
		sb.append(",song_duration="+String.valueOf(song_duration));
		sb.append(",song_release_year="+String.valueOf(song_release_year));
	    sb.append("]");
        	...
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(song_duration == null){
            				...
            				sb.append(song_duration);
            			}
            		
        			sb.append("|");
        		
        				sb.append(song_release_year);
...
public static class after_tDBInput_1Struct implements routines.system.IPersistableRow<after_tDBInput_1Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.song_id;
	...
	public void copyDataTo(after_tDBInput_1Struct other) {
		...
		other.song_id = this.song_id;
	            other.song_title = this.song_title;
	            other.artist_id = this.artist_id;
	            other.song_duration = this.song_duration;
	            other.song_release_year = this.song_release_year;
    ...
    public int compareTo(after_tDBInput_1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.song_id, other.song_id);
						if(returnValue != 0) {
							return returnValue;
						}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"songsdim\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("songsdim");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("songsdim");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"songid\" = ?,\"songtitle\" = ?,\"songduration\" = ?,\"releaseyear\" = ?,\"artistkey\" = ? WHERE \"songkey\" = ?";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"songsdim\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("songkey")+", NAME="+("\"songkey\"")+", SQL="+("\"nextval('songsdim_songkey_sequence')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("songsdim");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("songsdim");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "songkey" + "\",\"songid\",\"songtitle\",\"songduration\",\"releaseyear\",\"artistkey\") VALUES (" + "nextval('songsdim_songkey_sequence')" + ",?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT * FROM SONGS;\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("song_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("song_title")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("artist_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("song_duration")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("song_release_year")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM SONGS;";
            ...
            row1.song_id = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.song_title = null;
							} else {
	                         		
        	row1.song_title = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.artist_id = null;
							} else {
	                         		
        	row1.artist_id = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.song_duration = null;
							} else {
		                          
            row1.song_duration = rs_tDBInput_1.getBigDecimal(4);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.song_release_year = 0;
							} else {
		                          
            row1.song_release_year = rs_tDBInput_1.getInt(5);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.artistid = row1.artist_id ;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.artistid = '" + row2HashKey.artistid + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.songid = row1.song_id ;
                        		    		
                        		    		    row3HashKey.songtitle = row1.song_title ;
                        		    		
	                        		    	Object exprKeyValue_row3__artistkey = row2.artistkey ;
	                        		    	if(exprKeyValue_row3__artistkey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row3HashKey.artistkey = (int)(Integer) exprKeyValue_row3__artistkey;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.songid = '" + row3HashKey.songid + "', row3.songtitle = '" + row3HashKey.songtitle + "', row3.artistkey = '" + row3HashKey.artistkey + "'");
								} // G 071
...
Found1_tmp.songkey = row3.songkey ;
Found1_tmp.songid = row1.song_id ;
Found1_tmp.songtitle = row1.song_title ;
Found1_tmp.songduration = row1.song_duration ;
Found1_tmp.releaseyear = row1.song_release_year ;
Found1_tmp.artistkey = row2.artistkey ;
Found1 = Found1_tmp;
...
NotFound1_tmp.songkey = 0;
NotFound1_tmp.songid = row1.song_id ;
NotFound1_tmp.songtitle = row1.song_title ;
NotFound1_tmp.songduration = row1.song_duration ;
NotFound1_tmp.releaseyear = row1.song_release_year ;
NotFound1_tmp.artistkey = row2.artistkey ;
...
if(Found1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, Found1.songid);

                    if(Found1.songtitle == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, Found1.songtitle);
}

                    pstmt_tDBOutput_1.setBigDecimal(3, Found1.songduration);

                    pstmt_tDBOutput_1.setInt(4, Found1.releaseyear);

                    pstmt_tDBOutput_1.setInt(5, Found1.artistkey);

                    pstmt_tDBOutput_1.setInt(6 + count_tDBOutput_1, Found1.songkey);
...
if(NotFound1 != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    pstmt_tDBOutput_2.setInt(1, NotFound1.songid);

                    if(NotFound1.songtitle == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, NotFound1.songtitle);
}

                    pstmt_tDBOutput_2.setBigDecimal(3, NotFound1.songduration);

                    pstmt_tDBOutput_2.setInt(4, NotFound1.releaseyear);

                    pstmt_tDBOutput_2.setInt(5, NotFound1.artistkey);
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.artistid, other.artistid);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT * FROM ARTISTSDIM;\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("artistkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("artistid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("artistname")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("citykey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("startdate")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("enddate")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("status_flag")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
		    ...
		    String dbquery_tDBInput_3 = "SELECT * FROM ARTISTSDIM;";
            ...
            row2.artistkey = rs_tDBInput_3.getInt(1);
        	...
        	row2.artistid = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row2.artistname = null;
							} else {
	                         		
        	row2.artistname = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row2.citykey = 0;
							} else {
		                          
            row2.citykey = rs_tDBInput_3.getInt(4);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row2.startdate = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 5);
		                    }
							if(colQtyInRs_tDBInput_3 < 6) {
								row2.enddate = null;
							} else {
										
			row2.enddate = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 6);
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								row2.status_flag = null;
							} else {
	                         		
        	row2.status_flag = routines.system.JDBCUtil.getString(rs_tDBInput_3, 7, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row2_HashRow.artistid = row2.artistid;
				
				row2_HashRow.artistname = row2.artistname;
				...
				row2_HashRow.status_flag = row2.status_flag;
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
    ...
    public int compareTo(row3Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.songtitle, other.songtitle);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT * FROM SONGSDIM;\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("songkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("songid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("songtitle")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("songduration")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("releaseyear")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("artistkey")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
		    ...
		    String dbquery_tDBInput_2 = "SELECT * FROM SONGSDIM;";
            ...
            row3.songkey = rs_tDBInput_2.getInt(1);
            ...
            row3.songid = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    row3.songid = null;
            }
		                    }
        	...
        	row3.songtitle = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row3.songduration = null;
							} else {
		                          
            row3.songduration = rs_tDBInput_2.getBigDecimal(4);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.releaseyear = rs_tDBInput_2.getInt(5);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.artistkey = rs_tDBInput_2.getInt(6);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final SongsDim SongsDimClass = new SongsDim();

        int exitCode = SongsDimClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'SongsDim' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'SongsDim' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = SongsDim.class.getClassLoader().getResourceAsStream("artistloc/songsdim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SongsDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SongsDim");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     190458 characters generated by Talend Real-time Big Data Platform 
 *     on the November 15, 2024 at 1:49:21 PM EST
 ************************************************************************************************/