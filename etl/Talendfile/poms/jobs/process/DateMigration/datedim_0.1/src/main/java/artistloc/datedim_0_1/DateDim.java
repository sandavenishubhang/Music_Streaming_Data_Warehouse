...
public class DateDim implements TalendJob {
	static {System.setProperty("TalendJob.log", "DateDim.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(DateDim.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_ZDWKkJ7jEe-qffWMG6HUvg", "0.1");
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:a3aNXlVaIV0Q44aX+dMpsezpXYaznm08ksDaezZ7x+0L").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tgqS4nmVCyptCJ0CY7nggGe9nb/qWXt0ojGIBtXy4bW+");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:KkIoW6YLhR1jd1blPYMnmWXWovYUF5ljs+iPNFeEqSff").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:rw5lEcrh7/VyK+OcITPkdgvuTjU8fKqPHJWUErIbfap/");
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_ARTISTLOC_DateDim = new byte[0];
    static byte[] commonByteArray_ARTISTLOC_DateDim = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARTISTLOC_DateDim) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARTISTLOC_DateDim.length) {
				if(length < 1024 && commonByteArray_ARTISTLOC_DateDim.length == 0) {
   					commonByteArray_ARTISTLOC_DateDim = new byte[1024];
				} else {
   					commonByteArray_ARTISTLOC_DateDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARTISTLOC_DateDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_DateDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARTISTLOC_DateDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_DateDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"datedim\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"datekey\",\"date\",\"weekkey\") VALUES (?,?,?)";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_2{
                    ...
                    log4jParamters_tUniqRow_2.append("Parameters:");
                            log4jParamters_tUniqRow_2.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("datekey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("date")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("weekkey")+"}]");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"datedim\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("datekey")+", NAME="+("\"datekey\"")+", SQL="+("\"nextval('datedim_datekey_sequence')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "datekey" + "\",\"date\",\"weekkey\") VALUES (" + "nextval('datedim_datekey_sequence')" + ",?,?)";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_1{
                    ...
                    log4jParamters_tUniqRow_1.append("Parameters:");
                            log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("datekey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("date")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("weekkey")+"}]");
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row2__weeknumber = TalendDate.getPartOfDate("WEEK_OF_YEAR",row1.date);
	                        		    	if(exprKeyValue_row2__weeknumber == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.weeknumber = (int)(Integer) exprKeyValue_row2__weeknumber;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.weeknumber = '" + row2HashKey.weeknumber + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.date = row1.date  == null ? null : new java.util.Date(row1.date .getTime());
                        		    		
	                        		    	Object exprKeyValue_row3__weekkey = row2.weekkey ;
	                        		    	if(exprKeyValue_row3__weekkey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row3HashKey.weekkey = (int)(Integer) exprKeyValue_row3__weekkey;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.date = '" + row3HashKey.date + "', row3.weekkey = '" + row3HashKey.weekkey + "'");
								} // G 071
...
FOUND1_tmp.datekey = row3.datekey ;
FOUND1_tmp.date = row3.date ;
FOUND1_tmp.weekkey = row2.weekkey ;
FOUND1 = FOUND1_tmp;
...
NOTFOUND1_tmp.datekey = 0;
NOTFOUND1_tmp.date = row1.date ;
NOTFOUND1_tmp.weekkey = row2.weekkey ;
...
row5 = null;			
finder_tUniqRow_2.datekey = FOUND1.datekey;
finder_tUniqRow_2.date = FOUND1.date;
finder_tUniqRow_2.weekkey = FOUND1.weekkey;	
finder_tUniqRow_2.hashCodeDirty = true;
if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
		KeyStruct_tUniqRow_2 new_tUniqRow_2 = new KeyStruct_tUniqRow_2();

		
new_tUniqRow_2.datekey = FOUND1.datekey;
new_tUniqRow_2.date = FOUND1.date;
new_tUniqRow_2.weekkey = FOUND1.weekkey;
	...
	row5 = new row5Struct();
}row5.datekey = FOUND1.datekey;			row5.date = FOUND1.date;			row5.weekkey = FOUND1.weekkey;					
...
if(row5 != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row5","tUniqRow_2","tUniqRow_2","tUniqRow","tDBOutput_1","__TABLE__","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, row5.datekey);

                    if(row5.date != null) {
pstmt_tDBOutput_1.setTimestamp(2, new java.sql.Timestamp(row5.date.getTime()));
} else {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_1.setInt(3, row5.weekkey);
...
if(NOTFOUND1 != null) { 
	...
	currentComponent="tUniqRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NOTFOUND1","tMap_1","tMap_1","tMap","tUniqRow_1","tUniqRow_1","tUniqRow"
...
row4 = null;			
finder_tUniqRow_1.datekey = NOTFOUND1.datekey;
finder_tUniqRow_1.date = NOTFOUND1.date;
finder_tUniqRow_1.weekkey = NOTFOUND1.weekkey;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.datekey = NOTFOUND1.datekey;
new_tUniqRow_1.date = NOTFOUND1.date;
new_tUniqRow_1.weekkey = NOTFOUND1.weekkey;
	...
	row4 = new row4Struct();
}row4.datekey = NOTFOUND1.datekey;			row4.date = NOTFOUND1.date;			row4.weekkey = NOTFOUND1.weekkey;					
...
if(row4 != null) { 
	...
	currentComponent="tDBOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row4","tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_2","__TABLE__","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_2 = false;
                    if(row4.date != null) {
pstmt_tDBOutput_2.setTimestamp(1, new java.sql.Timestamp(row4.date.getTime()));
} else {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(2, row4.weekkey);
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            row2.weekkey = rs_tDBInput_2.getInt(1);
            ...
            row2.weeknumber = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.monthkey = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","__TABLE__","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
				...
				row2_HashRow.weekkey = row2.weekkey;
				
				row2_HashRow.weeknumber = row2.weeknumber;
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","__TABLE__","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT * FROM DATEDIM;\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("datekey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("date")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("weekkey")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
		    ...
		    String dbquery_tDBInput_3 = "SELECT * FROM DATEDIM;";
            ...
            row3.datekey = rs_tDBInput_3.getInt(1);
			...
			row3.date = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 2);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row3.weekkey = 0;
							} else {
		                          
            row3.weekkey = rs_tDBInput_3.getInt(3);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row3_HashRow.datekey = row3.datekey;
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = DateDimClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'DateDim' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'DateDim' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = DateDim.class.getClassLoader().getResourceAsStream("artistloc/datedim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     197795 characters generated by Talend Real-time Big Data Platform 
