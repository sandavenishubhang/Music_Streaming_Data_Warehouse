...
/**
 * Job: DayDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status DEV
 */
public class DayDim implements TalendJob {
	static {System.setProperty("TalendJob.log", "DayDim.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(DayDim.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "DayDim";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_51Z48J7DEe-wBqUbcMduCA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(DayDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:K70PuqT/UPVSD7KPs/HfJ5/ocG8fQzEI+u13jWZ9RsoQ").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:1fsWHTEdTgwOSjn97nnccxPv3M0V2tnMxr56f6NlegXG");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:YCrHwUCNavWDjn4FZUfAiAEV44JQqv5wTWRyyhhTU/mT").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:/9rNnnZCl14ePw0Hfhjw9jOSTfUMso68hyO5W1CTxF/r");
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_ARTISTLOC_DayDim = new byte[0];
    static byte[] commonByteArray_ARTISTLOC_DayDim = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.weekkey;
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARTISTLOC_DayDim) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.weeknumber = dis.readInt();
					
			        this.monthkey = dis.readInt();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.weeknumber);
					
					// int
				
		            	dos.writeInt(this.monthkey);
    ...
    public String toString() {
		...
		sb.append(",weeknumber="+String.valueOf(weeknumber));
		sb.append(",monthkey="+String.valueOf(monthkey));
	    sb.append("]");
    ...
    public int compareTo(row5Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.weekkey, other.weekkey);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARTISTLOC_DayDim.length) {
				if(length < 1024 && commonByteArray_ARTISTLOC_DayDim.length == 0) {
   					commonByteArray_ARTISTLOC_DayDim = new byte[1024];
				} else {
   					commonByteArray_ARTISTLOC_DayDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARTISTLOC_DayDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_DayDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARTISTLOC_DayDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_DayDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"weekdim\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("weekdim");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("weekdim");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"weeknumber\" = ?,\"monthkey\" = ? WHERE \"weekkey\" = ?";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_1{
                    ...
                    log4jParamters_tUniqRow_1.append("Parameters:");
                            log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("weekkey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("weeknumber")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("monthkey")+"}]");
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
									...
									result = prime * result + (int) this.weeknumber;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"weekdim\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("weekkey")+", NAME="+("\"weekkey\"")+", SQL="+("\"nextval('weekdim_weekkey_sequence')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("weekdim");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("weekdim");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "weekkey" + "\",\"weeknumber\",\"monthkey\") VALUES (" + "nextval('weekdim_weekkey_sequence')" + ",?,?)";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_2{
                    ...
                    log4jParamters_tUniqRow_2.append("Parameters:");
                            log4jParamters_tUniqRow_2.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("weekkey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("weeknumber")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("monthkey")+"}]");
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row6__calenderyear = TalendDate.getPartOfDate("YEAR",row1.date);
	                        		    	if(exprKeyValue_row6__calenderyear == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row6HashKey.calenderyear = (int)(Integer) exprKeyValue_row6__calenderyear;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row6.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.calenderyear = '" + row6HashKey.calenderyear + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.monthname = TalendDate.formatDate("MMMM", row1.date);
                        		    		
	                        		    	Object exprKeyValue_row2__yearkey = row6.yearkey ;
	                        		    	if(exprKeyValue_row2__yearkey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.yearkey = (int)(Integer) exprKeyValue_row2__yearkey;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.monthname = '" + row2HashKey.monthname + "', row2.yearkey = '" + row2HashKey.yearkey + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row3__weeknumber = TalendDate.getPartOfDate("WEEK_OF_YEAR",row1.date);
	                        		    	if(exprKeyValue_row3__weeknumber == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row3HashKey.weeknumber = (int)(Integer) exprKeyValue_row3__weeknumber;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row3__monthkey = row2.monthkey ;
	                        		    	if(exprKeyValue_row3__monthkey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row3HashKey.monthkey = (int)(Integer) exprKeyValue_row3__monthkey;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.weeknumber = '" + row3HashKey.weeknumber + "', row3.monthkey = '" + row3HashKey.monthkey + "'");
								} // G 071
...
Found1_tmp.weekkey = row3.weekkey ;
Found1_tmp.weeknumber = row3.weeknumber  ;
Found1_tmp.monthkey = row2.monthkey ;
Found1 = Found1_tmp;
...
NotFound1_tmp.weekkey = 0;
NotFound1_tmp.weeknumber = TalendDate.getPartOfDate("WEEK_OF_YEAR",row1.date);
NotFound1_tmp.monthkey = row2.monthkey ;
...
if(Found1 != null) { 
	...
	currentComponent="tUniqRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Found1","tMap_1","tMap_1","tMap","tUniqRow_1","tUniqRow_1","tUniqRow"
...
row4 = null;			
finder_tUniqRow_1.weekkey = Found1.weekkey;
finder_tUniqRow_1.weeknumber = Found1.weeknumber;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.weekkey = Found1.weekkey;
new_tUniqRow_1.weeknumber = Found1.weeknumber;
	...
	row4 = new row4Struct();
}row4.weekkey = Found1.weekkey;			row4.weeknumber = Found1.weeknumber;			row4.monthkey = Found1.monthkey;					
...
if(row4 != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row4","tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_1","__TABLE__","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, row4.weeknumber);

                    pstmt_tDBOutput_1.setInt(2, row4.monthkey);

                    pstmt_tDBOutput_1.setInt(3 + count_tDBOutput_1, row4.weekkey);
...
if(NotFound1 != null) { 
	...
	currentComponent="tUniqRow_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NotFound1","tMap_1","tMap_1","tMap","tUniqRow_2","tUniqRow_2","tUniqRow"
...
row5 = null;			
finder_tUniqRow_2.weekkey = NotFound1.weekkey;
finder_tUniqRow_2.weeknumber = NotFound1.weeknumber;	
finder_tUniqRow_2.hashCodeDirty = true;
if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
		KeyStruct_tUniqRow_2 new_tUniqRow_2 = new KeyStruct_tUniqRow_2();

		
new_tUniqRow_2.weekkey = NotFound1.weekkey;
new_tUniqRow_2.weeknumber = NotFound1.weeknumber;
		
		keystUniqRow_2.add(new_tUniqRow_2);if(row5 == null){ 
	
		log.trace("tUniqRow_2 - Writing the unique record " + (nb_uniques_tUniqRow_2+1) + " into row5.");
	
	row5 = new row5Struct();
}row5.weekkey = NotFound1.weekkey;			row5.weeknumber = NotFound1.weeknumber;			row5.monthkey = NotFound1.monthkey;					
...
if(row5 != null) { 
	...
	currentComponent="tDBOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row5","tUniqRow_2","tUniqRow_2","tUniqRow","tDBOutput_2","__TABLE__","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_2 = false;
                    pstmt_tDBOutput_2.setInt(1, row5.weeknumber);

                    pstmt_tDBOutput_2.setInt(2, row5.monthkey);
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row4",2,0,
			 			"tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_1","__TABLE__","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row5",2,0,
			 			"tUniqRow_2","tUniqRow_2","tUniqRow","tDBOutput_2","__TABLE__","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.monthname == null) ? 0 : this.monthname.hashCode());
							...
							result = prime * result + (int) this.yearkey;
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.monthkey = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.monthkey);
    ...
    public String toString() {
		...
		sb.append(",yearkey="+String.valueOf(yearkey));
	    sb.append("]");
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.monthname, other.monthname);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.yearkey, other.yearkey);
						if(returnValue != 0) {
							return returnValue;
						}
		...
		int tos_count_tAdvancedHash_row2 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row6) outputs:(Found1,NotFound1)
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT * FROM MONTHDIM;\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("monthkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("monthname")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("yearkey")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
		    ...
		    String dbquery_tDBInput_3 = "SELECT * FROM MONTHDIM;";
            ...
            row2.monthkey = rs_tDBInput_3.getInt(1);
        	...
        	row2.monthname = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row2.yearkey = 0;
							} else {
		                          
            row2.yearkey = rs_tDBInput_3.getInt(3);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row2_HashRow.monthkey = row2.monthkey;
				
				row2_HashRow.monthname = row2.monthname;
				
				row2_HashRow.yearkey = row2.yearkey;
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.monthkey;
	...
	public boolean equals(Object obj) {
		...
		final row3Struct other = (row3Struct) obj;
						...
						if (this.monthkey != other.monthkey)
							return false;
    ...
    public int compareTo(row3Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.weeknumber, other.weeknumber);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.monthkey, other.monthkey);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT * FROM WEEKDIM;\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("weekkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("weeknumber")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("monthkey")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
		    ...
		    String dbquery_tDBInput_2 = "SELECT * FROM WEEKDIM;";
            ...
            row3.weekkey = rs_tDBInput_2.getInt(1);
            ...
            row3.weeknumber = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.monthkey = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row3_HashRow.weekkey = row3.weekkey;
				
				row3_HashRow.weeknumber = row3.weeknumber;
				
				row3_HashRow.monthkey = row3.monthkey;
...
public static class row6Struct implements routines.system.IPersistableComparableLookupRow<row6Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.calenderyear;
	...
	public boolean equals(Object obj) {
		...
		final row6Struct other = (row6Struct) obj;
						...
						if (this.calenderyear != other.calenderyear)
							return false;
	...
	public void copyDataTo(row6Struct other) {
		...
		other.yearkey = this.yearkey;
	            other.calenderyear = this.calenderyear;
    ...
    public void writeKeysData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.calenderyear);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.yearkey);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("yearkey="+String.valueOf(yearkey));
		sb.append(",calenderyear="+String.valueOf(calenderyear));
	    sb.append("]");
    ...
    public int compareTo(row6Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.calenderyear, other.calenderyear);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_4{
                    ...
                    log4jParamters_tDBInput_4.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_4.append(" | ");
                            log4jParamters_tDBInput_4.append("QUERY" + " = " + "\"SELECT * FROM YEARDIM;\"");
                        log4jParamters_tDBInput_4.append(" | ");
                            log4jParamters_tDBInput_4.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_4.append(" | ");
                            log4jParamters_tDBInput_4.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_4.append(" | ");
                            log4jParamters_tDBInput_4.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("yearkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("calenderyear")+"}]");
                        log4jParamters_tDBInput_4.append(" | ");
		    ...
		    String dbquery_tDBInput_4 = "SELECT * FROM YEARDIM;";
            ...
            row6.yearkey = rs_tDBInput_4.getInt(1);
            ...
            row6.calenderyear = rs_tDBInput_4.getInt(2);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row6","tDBInput_4","__TABLE__","tPostgresqlInput","tAdvancedHash_row6","tAdvancedHash_row6","tAdvancedHash"
				...
				row6_HashRow.yearkey = row6.yearkey;
				
				row6_HashRow.calenderyear = row6.calenderyear;
...
tHash_Lookup_row6.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row6",2,0,
			 			"tDBInput_4","__TABLE__","tPostgresqlInput","tAdvancedHash_row6","tAdvancedHash_row6","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        final DayDim DayDimClass = new DayDim();

        int exitCode = DayDimClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'DayDim' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'DayDim' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = DayDim.class.getClassLoader().getResourceAsStream("artistloc/daydim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DayDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : DayDim");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     214475 characters generated by Talend Real-time Big Data Platform 
 *     on the November 15, 2024 at 1:49:19 PM EST
 ************************************************************************************************/