...
package artistloc.monthdim_0_1;
...
/**
 * Job: MonthDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status DEV
 */
public class MonthDim implements TalendJob {
	static {System.setProperty("TalendJob.log", "MonthDim.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(MonthDim.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "MonthDim";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_4bXEMJ7AEe-wBqUbcMduCA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MonthDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:RSMg5QhwU6Fn751XO5Ih2lK5UAlbYGbaczxxXMy7HKrg").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:x0vpQMFBpQRozAqWGCbKqP7LTquwyaQ6Xlz/dc/g+bHG");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:VJPoKbdiuaycQQgdQElxjVbbNAT19KqbUprebLYGKhVM").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:JlpYgup3I/2Kr4fbZMDJEfSIjgG9erGl3JvqrfgB/F8a");
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_ARTISTLOC_MonthDim = new byte[0];
    static byte[] commonByteArray_ARTISTLOC_MonthDim = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARTISTLOC_MonthDim.length) {
				if(length < 1024 && commonByteArray_ARTISTLOC_MonthDim.length == 0) {
   					commonByteArray_ARTISTLOC_MonthDim = new byte[1024];
				} else {
   					commonByteArray_ARTISTLOC_MonthDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARTISTLOC_MonthDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_MonthDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARTISTLOC_MonthDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_MonthDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARTISTLOC_MonthDim) {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"monthdim\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("monthdim");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("monthdim");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"monthname\" = ?,\"yearkey\" = ? WHERE \"monthkey\" = ?";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_1{
                    ...
                    log4jParamters_tUniqRow_1.append("Parameters:");
                            log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("monthkey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("monthname")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("yearkey")+"}]");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"monthdim\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("monthkey")+", NAME="+("\"monthkey\"")+", SQL="+("\"nextval('monthdim_monthkey_sequence')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("monthdim");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("monthdim");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "monthkey" + "\",\"monthname\",\"yearkey\") VALUES (" + "nextval('monthdim_monthkey_sequence')" + ",?,?)";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_2{
                    ...
                    log4jParamters_tUniqRow_2.append("Parameters:");
                            log4jParamters_tUniqRow_2.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("monthkey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("monthname")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("yearkey")+"}]");
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row2__calenderyear = TalendDate.getPartOfDate("YEAR",row1.date);
	                        		    	if(exprKeyValue_row2__calenderyear == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row2HashKey.calenderyear = (int)(Integer) exprKeyValue_row2__calenderyear;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.calenderyear = '" + row2HashKey.calenderyear + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.monthname = TalendDate.formatDate("MMMM", row1.date);
                        		    		
	                        		    	Object exprKeyValue_row3__yearkey = row2.yearkey ;
	                        		    	if(exprKeyValue_row3__yearkey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row3HashKey.yearkey = (int)(Integer) exprKeyValue_row3__yearkey;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.monthname = '" + row3HashKey.monthname + "', row3.yearkey = '" + row3HashKey.yearkey + "'");
								} // G 071
...
Found1_tmp.monthkey = row3.monthkey ;
Found1_tmp.monthname = row3.monthname ;
Found1_tmp.yearkey = row2.yearkey ;
Found1 = Found1_tmp;
...
NotFound1_tmp.monthkey = 0;
NotFound1_tmp.monthname = TalendDate.formatDate("MMMM", row1.date);
NotFound1_tmp.yearkey = row2.yearkey ;
...
row4 = null;			
finder_tUniqRow_1.monthkey = Found1.monthkey;
if(Found1.monthname == null){
	finder_tUniqRow_1.monthname = null;
}else{
	finder_tUniqRow_1.monthname = Found1.monthname.toLowerCase();
}
finder_tUniqRow_1.yearkey = Found1.yearkey;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.monthkey = Found1.monthkey;
if(Found1.monthname == null){
	new_tUniqRow_1.monthname = null;
}else{
	new_tUniqRow_1.monthname = Found1.monthname.toLowerCase();
}
new_tUniqRow_1.yearkey = Found1.yearkey;
	...
	row4 = new row4Struct();
}row4.monthkey = Found1.monthkey;			row4.monthname = Found1.monthname;			row4.yearkey = Found1.yearkey;					
...
if(row4 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row4.monthname == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row4.monthname);
}

                    pstmt_tDBOutput_1.setInt(2, row4.yearkey);

                    pstmt_tDBOutput_1.setInt(3 + count_tDBOutput_1, row4.monthkey);
...
row5 = null;			
finder_tUniqRow_2.monthkey = NotFound1.monthkey;
if(NotFound1.monthname == null){
	finder_tUniqRow_2.monthname = null;
}else{
	finder_tUniqRow_2.monthname = NotFound1.monthname.toLowerCase();
}
finder_tUniqRow_2.yearkey = NotFound1.yearkey;	
finder_tUniqRow_2.hashCodeDirty = true;
if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
		KeyStruct_tUniqRow_2 new_tUniqRow_2 = new KeyStruct_tUniqRow_2();

		
new_tUniqRow_2.monthkey = NotFound1.monthkey;
if(NotFound1.monthname == null){
	new_tUniqRow_2.monthname = null;
}else{
	new_tUniqRow_2.monthname = NotFound1.monthname.toLowerCase();
}
new_tUniqRow_2.yearkey = NotFound1.yearkey;
	...
	row5 = new row5Struct();
}row5.monthkey = NotFound1.monthkey;			row5.monthname = NotFound1.monthname;			row5.yearkey = NotFound1.yearkey;					
...
if(row5 != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(row5.monthname == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, row5.monthname);
}

                    pstmt_tDBOutput_2.setInt(2, row5.yearkey);
		...
		int tos_count_tAdvancedHash_row2 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2,row3) outputs:(Found1,NotFound1)
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT * FROM YEARDIM;\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("yearkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("calenderyear")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
		    ...
		    String dbquery_tDBInput_3 = "SELECT * FROM YEARDIM;";
            ...
            row2.yearkey = rs_tDBInput_3.getInt(1);
            ...
            row2.calenderyear = rs_tDBInput_3.getInt(2);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row2_HashRow.calenderyear = row2.calenderyear;
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT * FROM MONTHDIM;\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("monthkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("monthname")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("yearkey")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
		    ...
		    String dbquery_tDBInput_2 = "SELECT * FROM MONTHDIM;";
            ...
            row3.monthkey = rs_tDBInput_2.getInt(1);
        	...
        	row3.monthname = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row3.yearkey = 0;
							} else {
		                          
            row3.yearkey = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row3_HashRow.yearkey = row3.yearkey;
 ...
 */
    ...
    public static void main(String[] args){
        final MonthDim MonthDimClass = new MonthDim();

        int exitCode = MonthDimClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'MonthDim' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'MonthDim' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = MonthDim.class.getClassLoader().getResourceAsStream("artistloc/monthdim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MonthDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MonthDim");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     202513 characters generated by Talend Real-time Big Data Platform 
 *     on the November 15, 2024 at 1:49:18 PM EST
 ************************************************************************************************/