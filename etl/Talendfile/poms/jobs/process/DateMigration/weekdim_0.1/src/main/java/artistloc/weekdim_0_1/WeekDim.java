 ...
 * @status DEV
 */
public class WeekDim implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "WeekDim.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(WeekDim.class);
	...
	private final String jobName = "WeekDim";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(WeekDim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:jcQ6esnRGdYtEfyohd83E1ir4qk9UzAyZNAzAAEnjCaQ")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:M6qy64bhji2IuTQiYUWlkXrenyrbQuxWqdglS2V2WYqD");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:aGbreADMCFjCUeI5ux5FWGTUkXwWL8K8emA7WLNs4nJb")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:2mF22v8FhzeQwW0rckx0lL+M7fyj6VYId/xxycTYeJ5g");
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		final static byte[] commonByteArrayLock_ARTISTLOC_WeekDim = new byte[0];
		static byte[] commonByteArray_ARTISTLOC_WeekDim = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.daykey;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ARTISTLOC_WeekDim.length) {
					if (length < 1024 && commonByteArray_ARTISTLOC_WeekDim.length == 0) {
						commonByteArray_ARTISTLOC_WeekDim = new byte[1024];
					} else {
						commonByteArray_ARTISTLOC_WeekDim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ARTISTLOC_WeekDim, 0, length);
				strReturn = new String(commonByteArray_ARTISTLOC_WeekDim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_ARTISTLOC_WeekDim, 0, length);
				strReturn = new String(commonByteArray_ARTISTLOC_WeekDim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ARTISTLOC_WeekDim) {

				try {

					int length = 0;

					this.daykey = dis.readInt();
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("daykey=" + String.valueOf(daykey));
		...
		public int compareTo(row7Struct other) {
			...
			returnValue = checkNullsAndCompare(this.daykey, other.daykey);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"daydim\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("daydim");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("daydim");
				}
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"dayname\" = ?,\"weekkey\" = ? WHERE \"daykey\" = ?";
					...
					class BytesLimit65535_tUniqRow_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE=" + ("false")
									+ ", KEY_ATTRIBUTE=" + ("true") + ", SCHEMA_COLUMN=" + ("daykey")
									+ "}, {CASE_SENSITIVE=" + ("false") + ", KEY_ATTRIBUTE=" + ("true")
									+ ", SCHEMA_COLUMN=" + ("dayname") + "}, {CASE_SENSITIVE=" + ("false")
									+ ", KEY_ATTRIBUTE=" + ("false") + ", SCHEMA_COLUMN=" + ("weekkey") + "}]");
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result + ((this.dayname == null) ? 0 : this.dayname.hashCode());
					...
					public boolean equals(Object obj) {
						...
						} else if (!this.dayname.equals(other.dayname))
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"daydim\"");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = ("daydim");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("daydim");
				}
				...
				String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "daykey"
						+ "\",\"dayname\",\"weekkey\") VALUES (" + "nextval('daydim_daykey_sequence')" + ",?,?)";
				...
				util_tLogRow_1.addRow(new String[] { "daykey", "dayname", "weekkey", });
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    \\\"session\\\".\\\"session_id\\\",    \\\"session\\\".\\\"user_id\\\",    \\\"session\\\".\\\"song_id\\\",    \\\"session\\\".\\\"session_duration\\\",    \\\"session\\\".\\\"timestamp\\\",    \\\"session\\\".\\\"date\\\" FROM \\\"session\\\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("session_id") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("user_id") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("song_id")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("session_duration") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("timestamp") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("date") + "}]");
							log4jParamters_tDBInput_1.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.monthname = '" +
							// row2HashKey.monthname + "'");
						} // G 071
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							Object exprKeyValue_row4__weeknumber = TalendDate.getPartOfDate("WEEK_OF_YEAR", row1.date);
							if (exprKeyValue_row4__weeknumber == null) {
								hasCasePrimitiveKeyWithNull_tMap_1 = true;
							} else {
								row4HashKey.weeknumber = (int) (Integer) exprKeyValue_row4__weeknumber;
							}

							Object exprKeyValue_row4__monthkey = row2.monthkey;
							if (exprKeyValue_row4__monthkey == null) {
								hasCasePrimitiveKeyWithNull_tMap_1 = true;
							} else {
								row4HashKey.monthkey = (int) (Integer) exprKeyValue_row4__monthkey;
							}
						...
						if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row4.weeknumber = '" +
							// row4HashKey.weeknumber + "', row4.monthkey = '" + row4HashKey.monthkey +
							// "'");
						} // G 071
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row5HashKey.dayname = TalendDate.formatDate("EEEE", row1.date);

							Object exprKeyValue_row5__weekkey = row4.weekkey;
							if (exprKeyValue_row5__weekkey == null) {
								hasCasePrimitiveKeyWithNull_tMap_1 = true;
							} else {
								row5HashKey.weekkey = (int) (Integer) exprKeyValue_row5__weekkey;
							}
						...
						if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row5.dayname = '" +
							// row5HashKey.dayname + "', row5.weekkey = '" + row5HashKey.weekkey + "'");
						} // G 071
...
// # Output table : 'Found1'
								...
								Found1_tmp.daykey = row5.daykey;
								Found1_tmp.dayname = row5.dayname;
								Found1_tmp.weekkey = row4.weekkey;
								Found1 = Found1_tmp;
								log.debug("tMap_1 - Outputting the record " + count_Found1_tMap_1
										+ " of the output table 'Found1'.");
...
// # Filter conditions 
							if (rejectedInnerJoin_tMap_1) {
								...
								NotFound1_tmp.daykey = 0;
								NotFound1_tmp.dayname = TalendDate.formatDate("EEEE", row1.date);
								NotFound1_tmp.weekkey = row4.weekkey;
								NotFound1 = NotFound1_tmp;
								log.debug("tMap_1 - Outputting the record " + count_NotFound1_tMap_1
										+ " of the output table 'NotFound1'.");
...
// Start of branch "Found1"
						if (Found1 != null) {
							...
							row3 = null;
							finder_tUniqRow_1.daykey = Found1.daykey;
							if (Found1.dayname == null) {
								finder_tUniqRow_1.dayname = null;
							} else {
								finder_tUniqRow_1.dayname = Found1.dayname.toLowerCase();
							}
							finder_tUniqRow_1.hashCodeDirty = true;
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

								new_tUniqRow_1.daykey = Found1.daykey;
								if (Found1.dayname == null) {
									new_tUniqRow_1.dayname = null;
								} else {
									new_tUniqRow_1.dayname = Found1.dayname.toLowerCase();
								}
								...
								row3.daykey = Found1.daykey;
								row3.dayname = Found1.dayname;
								row3.weekkey = Found1.weekkey;
...
// Start of branch "row3"
							if (row3 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row3", "tUniqRow_1", "tUniqRow_1", "tUniqRow", "tDBOutput_1", "__TABLE__",
										"tPostgresqlOutput"
								...
								if (row3.dayname == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, row3.dayname);
								}

								pstmt_tDBOutput_1.setInt(2, row3.weekkey);

								pstmt_tDBOutput_1.setInt(3 + count_tDBOutput_1, row3.daykey);
...
// Start of branch "NotFound1"
						if (NotFound1 != null) {
							...
							row6 = null;
							finder_tUniqRow_2.daykey = NotFound1.daykey;
							if (NotFound1.dayname == null) {
								finder_tUniqRow_2.dayname = null;
							} else {
								finder_tUniqRow_2.dayname = NotFound1.dayname.toLowerCase();
							}
							finder_tUniqRow_2.hashCodeDirty = true;
							if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
								KeyStruct_tUniqRow_2 new_tUniqRow_2 = new KeyStruct_tUniqRow_2();

								new_tUniqRow_2.daykey = NotFound1.daykey;
								if (NotFound1.dayname == null) {
									new_tUniqRow_2.dayname = null;
								} else {
									new_tUniqRow_2.dayname = NotFound1.dayname.toLowerCase();
								}
								...
								row6.daykey = NotFound1.daykey;
								row6.dayname = NotFound1.dayname;
								row6.weekkey = NotFound1.weekkey;
...
// Start of branch "row6"
							if (row6 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row6", "tUniqRow_2", "tUniqRow_2", "tUniqRow", "tLogRow_1", "tLogRow_1",
										"tLogRow"
...
///////////////////////		
								...
								row_tLogRow_1[0] = String.valueOf(row6.daykey);

								if (row6.dayname != null) { //
									row_tLogRow_1[1] = String.valueOf(row6.dayname);

								} //

								row_tLogRow_1[2] = String.valueOf(row6.weekkey);
...
///////////////////////    			
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "row7", "tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_2", "__TABLE__",
										"tPostgresqlOutput"
								...
								if (row7.dayname == null) {
									pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(1, row7.dayname);
								}

								pstmt_tDBOutput_2.setInt(2, row7.weekkey);
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "Found1", 2, 0, "tMap_1",
						"tMap_1", "tMap", "tUniqRow_1", "tUniqRow_1", "tUniqRow", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tUniqRow_1", "tUniqRow_1", "tUniqRow", "tDBOutput_1", "__TABLE__", "tPostgresqlOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row6", 2, 0,
						"tUniqRow_2", "tUniqRow_2", "tUniqRow", "tLogRow_1", "tLogRow_1", "tLogRow", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row7", 2, 0,
						"tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_2", "__TABLE__", "tPostgresqlOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row4,row2,row5) outputs:(Found1,NotFound1)
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append(
									"TRIM_COLUMN" + " = " + "[{TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("weekkey")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("weeknumber")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("monthkey") + "}]");
							log4jParamters_tDBInput_2.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row4.weekkey = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row4.weeknumber = rs_tDBInput_2.getInt(2);
							if (rs_tDBInput_2.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row4.monthkey = rs_tDBInput_2.getInt(3);
							if (rs_tDBInput_2.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row4", "tDBInput_2", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row4",
						...
						row4_HashRow.weekkey = row4.weekkey;

						row4_HashRow.weeknumber = row4.weeknumber;

						row4_HashRow.monthkey = row4.monthkey;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row4", 2, 0,
						"tDBInput_2", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row4", "tAdvancedHash_row4",
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append(
									"TRIM_COLUMN" + " = " + "[{TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("monthkey")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("monthname") + "}, {TRIM="
											+ ("false") + ", SCHEMA_COLUMN=" + ("yearkey") + "}]");
							log4jParamters_tDBInput_3.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_3", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_3", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
						"tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				objectOut.writeInt(this.daykey);
		...
		public int compareTo(row5Struct other) {
			...
			returnValue = checkNullsAndCompare(this.dayname, other.dayname);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_5 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_5.append(" | ");
							log4jParamters_tDBInput_5.append("QUERY" + " = " + "\"SELECT * FROM DAYDIM;\"");
							log4jParamters_tDBInput_5.append(" | ");
							...
							log4jParamters_tDBInput_5.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("daykey") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("dayname") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("weekkey") + "}]");
							log4jParamters_tDBInput_5.append(" | ");
				...
				String dbquery_tDBInput_5 = "SELECT * FROM DAYDIM;";
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 1) {
							...
							row5.daykey = rs_tDBInput_5.getInt(1);
						...
						if (colQtyInRs_tDBInput_5 < 2) {
							...
							row5.dayname = routines.system.JDBCUtil.getString(rs_tDBInput_5, 2, false);
						}
						if (colQtyInRs_tDBInput_5 < 3) {
							row5.weekkey = 0;
						} else {

							row5.weekkey = rs_tDBInput_5.getInt(3);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row5", "tDBInput_5", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row5",
						...
						row5_HashRow.daykey = row5.daykey;

						row5_HashRow.dayname = row5.dayname;

						row5_HashRow.weekkey = row5.weekkey;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row5", 2, 0,
						"tDBInput_5", "__TABLE__", "tPostgresqlInput", "tAdvancedHash_row5", "tAdvancedHash_row5",
						"tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public static void main(String[] args) {
		final WeekDim WeekDimClass = new WeekDim();

		int exitCode = WeekDimClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'WeekDim' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'WeekDim' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = WeekDim.class.getClassLoader()
					.getResourceAsStream("artistloc/weekdim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = WeekDim.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : WeekDim");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 242947 characters generated by Talend Real-time Big Data Platform on the
 * November 14, 2024 at 12:54:07 PM EST
 ************************************************************************************************/