...
/**
 * Job: YearDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status DEV
 */
public class YearDim implements TalendJob {
	static {System.setProperty("TalendJob.log", "YearDim.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(YearDim.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "YearDim";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_Nj22oJ5uEe-wBqUbcMduCA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(YearDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:wEprJoGtJSucj/NQ30HoLmShiSA3xU9OT7syBeOpWfW9").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ygCVjO5pZIDG7aTIq1a1v6Yxj0OU075VvlWOtBG4l0pU");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:mWBm5xVQqIUoE5xoMupfChTgN7/+eyPudrBkOzc9VT0x").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:L6/jnYnD3TdbhIMbrlzOK5P1iUCKpTgfkCGO7xZgr0PF");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_ARTISTLOC_YearDim = new byte[0];
    static byte[] commonByteArray_ARTISTLOC_YearDim = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARTISTLOC_YearDim) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARTISTLOC_YearDim.length) {
				if(length < 1024 && commonByteArray_ARTISTLOC_YearDim.length == 0) {
   					commonByteArray_ARTISTLOC_YearDim = new byte[1024];
				} else {
   					commonByteArray_ARTISTLOC_YearDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARTISTLOC_YearDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_YearDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARTISTLOC_YearDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_YearDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"yeardim\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("yeardim");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("yeardim");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"calenderyear\" = ? WHERE \"yearkey\" = ?";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_2{
                    ...
                    log4jParamters_tUniqRow_2.append("Parameters:");
                            log4jParamters_tUniqRow_2.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("yearkey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("calenderyear")+"}]");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"yeardim\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("yearkey")+", NAME="+("\"yearkey\"")+", SQL="+("\"nextval('yeardim_yearkey_sequence')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("yeardim");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("yeardim");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "yearkey" + "\",\"calenderyear\") VALUES (" + "nextval('yeardim_yearkey_sequence')" + ",?)";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_1{
                    ...
                    log4jParamters_tUniqRow_1.append("Parameters:");
                            log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("yearkey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("calenderyear")+"}]");
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row3__calenderyear = TalendDate.getPartOfDate("YEAR",row1.date);
	                        		    	if(exprKeyValue_row3__calenderyear == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row3HashKey.calenderyear = (int)(Integer) exprKeyValue_row3__calenderyear;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.calenderyear = '" + row3HashKey.calenderyear + "'");
								} // G 071
...
Found1_tmp.yearkey = row3.yearkey ;
Found1_tmp.calenderyear = row3.calenderyear;
Found1 = Found1_tmp;
...
NotFound1_tmp.yearkey = 0;
NotFound1_tmp.calenderyear = TalendDate.getPartOfDate("YEAR",row1.date);
...
row4 = null;			
finder_tUniqRow_2.yearkey = Found1.yearkey;
finder_tUniqRow_2.calenderyear = Found1.calenderyear;	
finder_tUniqRow_2.hashCodeDirty = true;
if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
		KeyStruct_tUniqRow_2 new_tUniqRow_2 = new KeyStruct_tUniqRow_2();

		
new_tUniqRow_2.yearkey = Found1.yearkey;
new_tUniqRow_2.calenderyear = Found1.calenderyear;
		
		keystUniqRow_2.add(new_tUniqRow_2);if(row4 == null){ 
	
		log.trace("tUniqRow_2 - Writing the unique record " + (nb_uniques_tUniqRow_2+1) + " into row4.");
	
	row4 = new row4Struct();
}row4.yearkey = Found1.yearkey;			row4.calenderyear = Found1.calenderyear;					
...
if(row4 != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row4","tUniqRow_2","tUniqRow_2","tUniqRow","tDBOutput_1","__TABLE__","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, row4.calenderyear);

                    pstmt_tDBOutput_1.setInt(2 + count_tDBOutput_1, row4.yearkey);
...
row2 = null;			
finder_tUniqRow_1.yearkey = NotFound1.yearkey;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.yearkey = NotFound1.yearkey;
	...
	row2 = new row2Struct();
}row2.yearkey = NotFound1.yearkey;			row2.calenderyear = NotFound1.calenderyear;					
...
if(row2 != null) { 
	...
	currentComponent="tDBOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_2","__TABLE__","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_2 = false;
                    pstmt_tDBOutput_2.setInt(1, row2.calenderyear);
		...
		int tos_count_tAdvancedHash_row3 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row3) outputs:(Found1,NotFound1)
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT * FROM YEARDIM;\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("yearkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("calenderyear")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
		    ...
		    String dbquery_tDBInput_2 = "SELECT * FROM YEARDIM;";
            ...
            row3.yearkey = rs_tDBInput_2.getInt(1);
            ...
            row3.calenderyear = rs_tDBInput_2.getInt(2);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row3_HashRow.calenderyear = row3.calenderyear;
 ...
 */
    ...
    public static void main(String[] args){
        final YearDim YearDimClass = new YearDim();

        int exitCode = YearDimClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'YearDim' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'YearDim' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = YearDim.class.getClassLoader().getResourceAsStream("artistloc/yeardim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = YearDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : YearDim");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     166436 characters generated by Talend Real-time Big Data Platform 
