...
package artistloc.artistcity_0_1;
...
/**
 * Job: ArtistCity Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status DEV
 */
public class ArtistCity implements TalendJob {
	static {System.setProperty("TalendJob.log", "ArtistCity.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(ArtistCity.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "ArtistCity";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_EMJTsJ2aEe-pKPIXzRwDrA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ArtistCity.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:HUTpPAvWi0atLdsXWCJl2CunsnB7VTIYiX5tg+ut2mzF").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:nEcn/NuVuVi1JW1ngMenTbAC6Iw5I4bCFi/VT/J5BNhX");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:b4tXGPG+HqyxDM1AHuc+oo3ZOa1QoJhYyn0gA+j17kwa").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WdwZ1M4Eh45YSwzZ/UkIp3S5MdsC4rDWbXzc5NOm8F3X");
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_ARTISTLOC_ArtistCity = new byte[0];
    static byte[] commonByteArray_ARTISTLOC_ArtistCity = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARTISTLOC_ArtistCity.length) {
				if(length < 1024 && commonByteArray_ARTISTLOC_ArtistCity.length == 0) {
   					commonByteArray_ARTISTLOC_ArtistCity = new byte[1024];
				} else {
   					commonByteArray_ARTISTLOC_ArtistCity = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARTISTLOC_ArtistCity, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_ArtistCity, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARTISTLOC_ArtistCity, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_ArtistCity, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARTISTLOC_ArtistCity) {
    ...
    public String toString() {
		...
		sb.append(",statekey="+String.valueOf(statekey));
	    sb.append("]");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		synchronized(commonByteArrayLock_ARTISTLOC_ArtistCity) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.location_name = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.location_name,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("location_name="+location_name);
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"citydim\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("citydim");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("citydim");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"cityname\" = ?,\"statekey\" = ? WHERE \"citykey\" = ?";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_2{
                    ...
                    log4jParamters_tUniqRow_2.append("Parameters:");
                            log4jParamters_tUniqRow_2.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("citykey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("cityname")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("statekey")+"}]");
				...
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.cityname == null) ? 0 : this.cityname.hashCode());
									...
									result = prime * result + (int) this.statekey;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"citydim\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("citykey")+", NAME="+("\"citykey\"")+", SQL="+("\"nextval('citydim_citykey_sequence')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("citydim");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("citydim");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "citykey" + "\",\"cityname\",\"statekey\") VALUES (" + "nextval('citydim_citykey_sequence')" + ",?,?)";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_1{
                    ...
                    log4jParamters_tUniqRow_1.append("Parameters:");
                            log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("citykey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("cityname")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("statekey")+"}]");
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT DISTINCT location_name, country From Artists;\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("location_name")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("country")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "SELECT DISTINCT location_name, country From Artists;";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.location_name = null;
							} else {
	                         		
        	row1.location_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.statecode = row1.location_name != null && row1.location_name.contains(",") ? row1.location_name.split(",")[1].trim() : "UNKNOWN"
;
                        		    		
	                        		    	Object exprKeyValue_row3__countrykey = row2.countrykey ;
	                        		    	if(exprKeyValue_row3__countrykey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row3HashKey.countrykey = (int)(Integer) exprKeyValue_row3__countrykey;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.statecode = '" + row3HashKey.statecode + "', row3.countrykey = '" + row3HashKey.countrykey + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row4__statekey = row3.statekey ;
	                        		    	if(exprKeyValue_row4__statekey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row4HashKey.statekey = (int)(Integer) exprKeyValue_row4__statekey;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row4.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.statekey = '" + row4HashKey.statekey + "'");
								} // G 071
...
Found1_tmp.citykey = row4.citykey ;
Found1_tmp.cityname = row1.location_name != null ? row1.location_name.substring(0, row1.location_name.indexOf(",")) : null
;
Found1_tmp.statekey = row3.statekey ;
Found1 = Found1_tmp;
...
NotFound_tmp.citykey = 0;
NotFound_tmp.cityname = row1.location_name != null ? row1.location_name.substring(0, row1.location_name.indexOf(",")) : null
;
NotFound_tmp.statekey = row3.statekey ;
...
if(Found1 != null) { 
	...
	currentComponent="tUniqRow_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Found1","tMap_1","tMap_1","tMap","tUniqRow_2","tUniqRow_2","tUniqRow"
...
row6 = null;			
finder_tUniqRow_2.citykey = Found1.citykey;
if(Found1.cityname == null){
	finder_tUniqRow_2.cityname = null;
}else{
	finder_tUniqRow_2.cityname = Found1.cityname.toLowerCase();
}
finder_tUniqRow_2.statekey = Found1.statekey;	
finder_tUniqRow_2.hashCodeDirty = true;
if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
		KeyStruct_tUniqRow_2 new_tUniqRow_2 = new KeyStruct_tUniqRow_2();

		
new_tUniqRow_2.citykey = Found1.citykey;
if(Found1.cityname == null){
	new_tUniqRow_2.cityname = null;
}else{
	new_tUniqRow_2.cityname = Found1.cityname.toLowerCase();
}
new_tUniqRow_2.statekey = Found1.statekey;
		
		keystUniqRow_2.add(new_tUniqRow_2);if(row6 == null){ 
	
		log.trace("tUniqRow_2 - Writing the unique record " + (nb_uniques_tUniqRow_2+1) + " into row6.");
	
	row6 = new row6Struct();
}row6.citykey = Found1.citykey;			row6.cityname = Found1.cityname;			row6.statekey = Found1.statekey;					
...
if(row6 != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row6","tUniqRow_2","tUniqRow_2","tUniqRow","tDBOutput_1","__TABLE__","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row6.cityname == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row6.cityname);
}

                    pstmt_tDBOutput_1.setInt(2, row6.statekey);

                    pstmt_tDBOutput_1.setInt(3 + count_tDBOutput_1, row6.citykey);
...
if(NotFound != null) { 
	...
	currentComponent="tUniqRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"NotFound","tMap_1","tMap_1","tMap","tUniqRow_1","tUniqRow_1","tUniqRow"
...
row5 = null;			
finder_tUniqRow_1.citykey = NotFound.citykey;
if(NotFound.cityname == null){
	finder_tUniqRow_1.cityname = null;
}else{
	finder_tUniqRow_1.cityname = NotFound.cityname.toLowerCase();
}
finder_tUniqRow_1.statekey = NotFound.statekey;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.citykey = NotFound.citykey;
if(NotFound.cityname == null){
	new_tUniqRow_1.cityname = null;
}else{
	new_tUniqRow_1.cityname = NotFound.cityname.toLowerCase();
}
new_tUniqRow_1.statekey = NotFound.statekey;
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row5 == null){ 
	
		log.trace("tUniqRow_1 - Writing the unique record " + (nb_uniques_tUniqRow_1+1) + " into row5.");
	
	row5 = new row5Struct();
}row5.citykey = NotFound.citykey;			row5.cityname = NotFound.cityname;			row5.statekey = NotFound.statekey;					
...
if(row5 != null) { 
	...
	currentComponent="tDBOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row5","tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_2","__TABLE__","tPostgresqlOutput"
        ...
        whetherReject_tDBOutput_2 = false;
                    if(row5.cityname == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, row5.cityname);
}

                    pstmt_tDBOutput_2.setInt(2, row5.statekey);
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row6",2,0,
			 			"tUniqRow_2","tUniqRow_2","tUniqRow","tDBOutput_1","__TABLE__","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row5",2,0,
			 			"tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_2","__TABLE__","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.statekey = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.statekey);
		...
		int tos_count_tAdvancedHash_row3 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row3,row4,row2) outputs:(Found1,NotFound)
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT * FROM STATEDIM;\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("statekey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("statename")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("statecode")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("countrykey")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
		    ...
		    String dbquery_tDBInput_3 = "SELECT * FROM STATEDIM;";
            ...
            row3.statekey = rs_tDBInput_3.getInt(1);
        	...
        	row3.statename = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row3.statecode = null;
							} else {
	                         		
        	row3.statecode = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row3.countrykey = 0;
							} else {
		                          
            row3.countrykey = rs_tDBInput_3.getInt(4);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tDBInput_3","__TABLE__","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash"
				...
				row3_HashRow.statekey = row3.statekey;
				
				row3_HashRow.statename = row3.statename;
				
				row3_HashRow.statecode = row3.statecode;
				
				row3_HashRow.countrykey = row3.countrykey;
...
tHash_Lookup_row3.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tDBInput_3","__TABLE__","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
    ...
    public int compareTo(row4Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.statekey, other.statekey);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT * FROM CITYDIM;\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("citykey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("cityname")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("statekey")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
		    ...
		    String dbquery_tDBInput_2 = "SELECT * FROM CITYDIM;";
            ...
            row4.citykey = rs_tDBInput_2.getInt(1);
        	...
        	row4.cityname = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row4.statekey = 0;
							} else {
		                          
            row4.statekey = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row4","tDBInput_2","__TABLE__","tPostgresqlInput","tAdvancedHash_row4","tAdvancedHash_row4","tAdvancedHash"
				...
				row4_HashRow.statekey = row4.statekey;
...
tHash_Lookup_row4.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row4",2,0,
			 			"tDBInput_2","__TABLE__","tPostgresqlInput","tAdvancedHash_row4","tAdvancedHash_row4","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_4{
                    ...
                    log4jParamters_tDBInput_4.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_4.append(" | ");
                            log4jParamters_tDBInput_4.append("QUERY" + " = " + "\"SELECT * FROM COUNTRYDIM;\"");
                        log4jParamters_tDBInput_4.append(" | ");
                            log4jParamters_tDBInput_4.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_4.append(" | ");
                            log4jParamters_tDBInput_4.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_4.append(" | ");
                            log4jParamters_tDBInput_4.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("countrykey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("country")+"}]");
                        log4jParamters_tDBInput_4.append(" | ");
		    ...
		    String dbquery_tDBInput_4 = "SELECT * FROM COUNTRYDIM;";
            ...
            row2.countrykey = rs_tDBInput_4.getInt(1);
        	...
        	row2.country = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final ArtistCity ArtistCityClass = new ArtistCity();

        int exitCode = ArtistCityClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'ArtistCity' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'ArtistCity' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = ArtistCity.class.getClassLoader().getResourceAsStream("artistloc/artistcity_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ArtistCity.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ArtistCity");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     220814 characters generated by Talend Real-time Big Data Platform 
 *     on the November 15, 2024 at 1:49:17 PM EST
 ************************************************************************************************/