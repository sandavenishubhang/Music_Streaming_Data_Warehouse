...
package artistloc.sessionsdim_0_1;
...
/**
 * Job: SessionsDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status DEV
 */
public class SessionsDim implements TalendJob {
	static {System.setProperty("TalendJob.log", "SessionsDim.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(SessionsDim.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SessionsDim";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_cttFAJ76Ee-qffWMG6HUvg", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SessionsDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:JkO6PiHuConKOPcdntJFODjwRDCuDZkn+xUOO1C9u6uB").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:M5jCzWbwTyppB4yt3UzepwFdLUu2TE2dFy958FbLou3I");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:gmlxhwpRGEVB6aH5jmFEcM49bMMZWOEj5klInCXAnFFp").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:n0+DDxVYTvY6BHk8GxrDThA+GAZO8j59ivsBgVd7d/mc");
...
public static class Found1Struct implements routines.system.IPersistableRow<Found1Struct> {
    final static byte[] commonByteArrayLock_ARTISTLOC_SessionsDim = new byte[0];
    static byte[] commonByteArray_ARTISTLOC_SessionsDim = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARTISTLOC_SessionsDim.length) {
				if(length < 1024 && commonByteArray_ARTISTLOC_SessionsDim.length == 0) {
   					commonByteArray_ARTISTLOC_SessionsDim = new byte[1024];
				} else {
   					commonByteArray_ARTISTLOC_SessionsDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARTISTLOC_SessionsDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_SessionsDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARTISTLOC_SessionsDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_SessionsDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARTISTLOC_SessionsDim) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    public String toString() {
		...
		sb.append(",song_id="+String.valueOf(song_id));
		sb.append(",session_duration="+String.valueOf(session_duration));
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"sessionsdim\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("sessionsdim");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("sessionsdim");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"session_id\" = ?,\"userkey\" = ?,\"songkey\" = ?,\"session_duration\" = ?,\"timekey\" = ?,\"datekey\" = ? WHERE \"sessionkey\" = ?";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"sessionsdim\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("sessionkey")+", NAME="+("\"sessionkey\"")+", SQL="+("\"nextval('sessionsdim_sessionkey_sequence')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("sessionsdim");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("sessionsdim");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "sessionkey" + "\",\"session_id\",\"userkey\",\"songkey\",\"session_duration\",\"timekey\",\"datekey\") VALUES (" + "nextval('sessionsdim_sessionkey_sequence')" + ",?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT * FROM SESSION;\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("session_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("user_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("song_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("session_duration")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("timestamp")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("date")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM SESSION;";
        	...
        	row1.session_id = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.user_id = 0;
							} else {
		                          
            row1.user_id = rs_tDBInput_1.getInt(2);
            ...
            row1.song_id = rs_tDBInput_1.getInt(3);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.session_duration = rs_tDBInput_1.getBigDecimal(4);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row1.timestamp = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 5);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.date = null;
							} else {
										
			row1.date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 6);
		                    }
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row6HashKey.date = row1.date  == null ? null : new java.util.Date(row1.date .getTime());
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.songid = row1.song_id ;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.songid = '" + row2HashKey.songid + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
	                        		    	...
	                        		    	Object exprKeyValue_row3__userid = row1.user_id ;
	                        		    	if(exprKeyValue_row3__userid == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row3HashKey.userid = (int)(Integer) exprKeyValue_row3__userid;
                        		    		}
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row4HashKey.timestamp = row1.timestamp  == null ? null : new java.util.Date(row1.timestamp .getTime());
								  ...
								  if(!tHash_Lookup_row4.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.timestamp = '" + row4HashKey.timestamp + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row5HashKey.session_id = row1.session_id ;
                        		    		
	                        		    	Object exprKeyValue_row5__userkey = row3.userkey ;
	                        		    	if(exprKeyValue_row5__userkey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row5HashKey.userkey = (int)(Integer) exprKeyValue_row5__userkey;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row5__songkey = row2.songkey ;
	                        		    	if(exprKeyValue_row5__songkey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row5HashKey.songkey = (int)(Integer) exprKeyValue_row5__songkey;
                        		    		}
                        		    		
                        		    		    row5HashKey.session_duration = row2.songduration ;
                        		    		
	                        		    	Object exprKeyValue_row5__timekey = row4.timekey ;
	                        		    	if(exprKeyValue_row5__timekey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row5HashKey.timekey = (int)(Integer) exprKeyValue_row5__timekey;
                        		    		}
                        		    		
	                        		    	Object exprKeyValue_row5__datekey = row6.datekey ;
	                        		    	if(exprKeyValue_row5__datekey == null) {
	                        		    		hasCasePrimitiveKeyWithNull_tMap_1 = true;
	                        		    	} else {
                        		    			row5HashKey.datekey = (int)(Integer) exprKeyValue_row5__datekey;
                        		    		}
								  ...
								  if(hasCasePrimitiveKeyWithNull_tMap_1 || !tHash_Lookup_row5.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.session_id = '" + row5HashKey.session_id + "', row5.userkey = '" + row5HashKey.userkey + "', row5.songkey = '" + row5HashKey.songkey + "', row5.session_duration = '" + row5HashKey.session_duration + "', row5.timekey = '" + row5HashKey.timekey + "', row5.datekey = '" + row5HashKey.datekey + "'");
								} // G 071
...
Found1_tmp.sessionkey = row5.sessionkey ;
Found1_tmp.session_id = null;
Found1_tmp.userkey = row3.userkey ;
Found1_tmp.songkey = row2.songkey ;
Found1_tmp.session_duration = row2.songduration ;
Found1_tmp.timekey = row4.timekey ;
Found1_tmp.datekey = row6.datekey ;
Found1 = Found1_tmp;
...
NotFound1_tmp.sessionkey = 0;
NotFound1_tmp.session_id = row1.session_id ;
NotFound1_tmp.userkey = row3.userkey ;
NotFound1_tmp.songkey = row2.songkey;
NotFound1_tmp.session_duration =  row1.session_duration ;
NotFound1_tmp.timekey = row4.timekey ;
NotFound1_tmp.datekey = row6.datekey ;
...
if(Found1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(Found1.session_id == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, Found1.session_id);
}

                    pstmt_tDBOutput_1.setInt(2, Found1.userkey);

                    pstmt_tDBOutput_1.setInt(3, Found1.songkey);

                    pstmt_tDBOutput_1.setBigDecimal(4, Found1.session_duration);

                    pstmt_tDBOutput_1.setInt(5, Found1.timekey);

                    pstmt_tDBOutput_1.setInt(6, Found1.datekey);

                    pstmt_tDBOutput_1.setInt(7 + count_tDBOutput_1, Found1.sessionkey);
...
if(NotFound1 != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(NotFound1.session_id == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, NotFound1.session_id);
}

                    pstmt_tDBOutput_2.setInt(2, NotFound1.userkey);

                    pstmt_tDBOutput_2.setInt(3, NotFound1.songkey);

                    pstmt_tDBOutput_2.setBigDecimal(4, NotFound1.session_duration);

                    pstmt_tDBOutput_2.setInt(5, NotFound1.timekey);

                    pstmt_tDBOutput_2.setInt(6, NotFound1.datekey);
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.songid, other.songid);
						if(returnValue != 0) {
							return returnValue;
						}
		...
		int tos_count_tAdvancedHash_row2 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5,row6) outputs:(Found1,NotFound1)
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT * FROM SONGSDIM;\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("songkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("songid")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("songtitle")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("songduration")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("releaseyear")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("artistkey")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
		    ...
		    String dbquery_tDBInput_3 = "SELECT * FROM SONGSDIM;";
            ...
            row2.songkey = rs_tDBInput_3.getInt(1);
            ...
            row2.songid = rs_tDBInput_3.getInt(2);
            if(rs_tDBInput_3.wasNull()){
                    row2.songid = null;
            }
		                    }
        	...
        	row2.songtitle = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row2.songduration = null;
							} else {
		                          
            row2.songduration = rs_tDBInput_3.getBigDecimal(4);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.releaseyear = rs_tDBInput_3.getInt(5);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.artistkey = rs_tDBInput_3.getInt(6);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row2_HashRow.songid = row2.songid;
				
				row2_HashRow.songtitle = row2.songtitle;
				
				row2_HashRow.songduration = row2.songduration;
				
				row2_HashRow.releaseyear = row2.releaseyear;
				
				row2_HashRow.artistkey = row2.artistkey;
 ...
 */
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
            ...
            row3.userkey = rs_tDBInput_4.getInt(1);
            ...
            row3.userid = rs_tDBInput_4.getInt(2);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row3.first_name = routines.system.JDBCUtil.getString(rs_tDBInput_4, 3, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 4) {
								row3.last_name = null;
							} else {
	                         		
        	row3.last_name = routines.system.JDBCUtil.getString(rs_tDBInput_4, 4, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 5) {
								row3.gender = null;
							} else {
	                         		
        	row3.gender = routines.system.JDBCUtil.getString(rs_tDBInput_4, 5, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 6) {
								row3.subscriptiontype = null;
							} else {
	                         		
        	row3.subscriptiontype = routines.system.JDBCUtil.getString(rs_tDBInput_4, 6, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 7) {
								row3.startdate = null;
							} else {
										
			row3.startdate = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 7);
		                    }
							if(colQtyInRs_tDBInput_4 < 8) {
								row3.enddate = null;
							} else {
										
			row3.enddate = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 8);
		                    }
							if(colQtyInRs_tDBInput_4 < 9) {
								row3.status = null;
							} else {
	                         		
        	row3.status = routines.system.JDBCUtil.getString(rs_tDBInput_4, 9, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 10) {
								row3.citykey = 0;
							} else {
		                          
            row3.citykey = rs_tDBInput_4.getInt(10);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tDBInput_4","__TABLE__","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash"
				...
				row3_HashRow.subscriptiontype = row3.subscriptiontype;
				
				row3_HashRow.startdate = row3.startdate;
				
				row3_HashRow.enddate = row3.enddate;
...
tHash_Lookup_row3.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tDBInput_4","__TABLE__","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
    ...
    public int compareTo(row4Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.timestamp, other.timestamp);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_5";
		...
		int tos_count_tDBInput_5 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_5{
                    ...
                    log4jParamters_tDBInput_5.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_5.append(" | ");
                            log4jParamters_tDBInput_5.append("QUERY" + " = " + "\"SELECT * FROM TIMEDIM;\"");
                        log4jParamters_tDBInput_5.append(" | ");
                            log4jParamters_tDBInput_5.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_5.append(" | ");
                            log4jParamters_tDBInput_5.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_5.append(" | ");
                            log4jParamters_tDBInput_5.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("timekey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("timestamp")+"}]");
                        log4jParamters_tDBInput_5.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_5", "__TABLE__", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
			}
		    ...
		    String dbquery_tDBInput_5 = "SELECT * FROM TIMEDIM;";
            ...
            row4.timekey = rs_tDBInput_5.getInt(1);
			...
			row4.timestamp = routines.system.JDBCUtil.getDate(rs_tDBInput_5, 2);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row4","tDBInput_5","__TABLE__","tPostgresqlInput","tAdvancedHash_row4","tAdvancedHash_row4","tAdvancedHash"
				...
				row4_HashRow.timekey = row4.timekey;
				
				row4_HashRow.timestamp = row4.timestamp;
...
tHash_Lookup_row4.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row4",2,0,
			 			"tDBInput_5","__TABLE__","tPostgresqlInput","tAdvancedHash_row4","tAdvancedHash_row4","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.session_id == null) ? 0 : this.session_id.hashCode());
					
							result = prime * result + (int) this.userkey;
						
							result = prime * result + (int) this.songkey;
						
						result = prime * result + ((this.session_duration == null) ? 0 : new Double(this.session_duration.doubleValue()).hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row5Struct other = (row5Struct) obj;
						...
						} else if (!this.session_id.equals(other.session_id))
						...
						if (this.session_duration == null) {
							if (other.session_duration != null)
								return false;
						
						} else if ((other.session_duration == null) || (this.session_duration.compareTo(other.session_duration)!=0))
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.sessionkey = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.sessionkey);
    ...
    public int compareTo(row5Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.session_id, other.session_id);
						if(returnValue != 0) {
							return returnValue;
						}
						...
						returnValue = checkNullsAndCompare(this.session_duration, other.session_duration);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT * FROM SESSIONSDIM;\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("sessionkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("session_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("userkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("songkey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("session_duration")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("timekey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("datekey")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
		    ...
		    String dbquery_tDBInput_2 = "SELECT * FROM SESSIONSDIM;";
            ...
            row5.sessionkey = rs_tDBInput_2.getInt(1);
        	...
        	row5.session_id = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row5.userkey = 0;
							} else {
		                          
            row5.userkey = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row5.songkey = rs_tDBInput_2.getInt(4);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row5.session_duration = null;
							} else {
		                          
            row5.session_duration = rs_tDBInput_2.getBigDecimal(5);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row5.timekey = rs_tDBInput_2.getInt(6);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row5.datekey = rs_tDBInput_2.getInt(7);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row5","tDBInput_2","__TABLE__","tPostgresqlInput","tAdvancedHash_row5","tAdvancedHash_row5","tAdvancedHash"
				...
				row5_HashRow.sessionkey = row5.sessionkey;
				
				row5_HashRow.session_id = row5.session_id;
				
				row5_HashRow.userkey = row5.userkey;
				
				row5_HashRow.songkey = row5.songkey;
				
				row5_HashRow.session_duration = row5.session_duration;
...
tHash_Lookup_row5.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row5",2,0,
			 			"tDBInput_2","__TABLE__","tPostgresqlInput","tAdvancedHash_row5","tAdvancedHash_row5","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
...
public static class row6Struct implements routines.system.IPersistableComparableLookupRow<row6Struct> {
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.weekkey);
    ...
    public String toString() {
		...
		sb.append("datekey="+String.valueOf(datekey));
		sb.append(",date="+String.valueOf(date));
		sb.append(",weekkey="+String.valueOf(weekkey));
	    sb.append("]");
 ...
 */
	...
	currentComponent="tDBInput_6";
		...
		int tos_count_tDBInput_6 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_6{
                    ...
                    log4jParamters_tDBInput_6.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_6.append(" | ");
                            log4jParamters_tDBInput_6.append("QUERY" + " = " + "\"SELECT * FROM DATEDIM;\"");
                        log4jParamters_tDBInput_6.append(" | ");
                            log4jParamters_tDBInput_6.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_6.append(" | ");
                            log4jParamters_tDBInput_6.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_6.append(" | ");
                            log4jParamters_tDBInput_6.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("datekey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("date")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("weekkey")+"}]");
                        log4jParamters_tDBInput_6.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_6", "__TABLE__", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
			}
		    ...
		    String dbquery_tDBInput_6 = "SELECT * FROM DATEDIM;";
            ...
            row6.datekey = rs_tDBInput_6.getInt(1);
			...
			row6.date = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 2);
		                    }
							if(colQtyInRs_tDBInput_6 < 3) {
								row6.weekkey = 0;
							} else {
		                          
            row6.weekkey = rs_tDBInput_6.getInt(3);
            if(rs_tDBInput_6.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row6","tDBInput_6","__TABLE__","tPostgresqlInput","tAdvancedHash_row6","tAdvancedHash_row6","tAdvancedHash"
				...
				row6_HashRow.datekey = row6.datekey;
				
				row6_HashRow.date = row6.date;
				
				row6_HashRow.weekkey = row6.weekkey;
...
tHash_Lookup_row6.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row6",2,0,
			 			"tDBInput_6","__TABLE__","tPostgresqlInput","tAdvancedHash_row6","tAdvancedHash_row6","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        final SessionsDim SessionsDimClass = new SessionsDim();

        int exitCode = SessionsDimClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'SessionsDim' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'SessionsDim' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = SessionsDim.class.getClassLoader().getResourceAsStream("artistloc/sessionsdim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SessionsDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SessionsDim");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     266605 characters generated by Talend Real-time Big Data Platform 
 *     on the November 15, 2024 at 1:49:22 PM EST
 ************************************************************************************************/