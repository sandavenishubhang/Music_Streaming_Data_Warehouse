...
/**
 * Job: TimeDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status DEV
 */
public class TimeDim implements TalendJob {
	static {System.setProperty("TalendJob.log", "TimeDim.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(TimeDim.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "TimeDim";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_0bm4AJ7qEe-qffWMG6HUvg", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TimeDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_1{
                    ...
                    log4jParamters_tDBConnection_1.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_1.append(" | ");
                            log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:LikpOFTxQ888UYIE7424PoikV9fik41IV1syf/N20moT").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_1.append(" | ");
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3eU3QP1UNtXxruPUhSxgsiSa01TupkGWQOROO3aOB8Uf");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:TIdjAQgD8uOcBVIW03ksz/EirhvUy2I7ehXWVHKxxLmq").substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:oOEKDBBQXSaYKzrCT9wrtGq2QrIIhTgpKensD4HWJ7cF");
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_ARTISTLOC_TimeDim = new byte[0];
    static byte[] commonByteArray_ARTISTLOC_TimeDim = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ARTISTLOC_TimeDim) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ARTISTLOC_TimeDim.length) {
				if(length < 1024 && commonByteArray_ARTISTLOC_TimeDim.length == 0) {
   					commonByteArray_ARTISTLOC_TimeDim = new byte[1024];
				} else {
   					commonByteArray_ARTISTLOC_TimeDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ARTISTLOC_TimeDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_TimeDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ARTISTLOC_TimeDim, 0, length);
			strReturn = new String(commonByteArray_ARTISTLOC_TimeDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"timedim\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("timedim");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("timedim");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"timestamp\" = ? WHERE \"timekey\" = ?";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_2{
                    ...
                    log4jParamters_tUniqRow_2.append("Parameters:");
                            log4jParamters_tUniqRow_2.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("timekey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("timestamp")+"}]");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"timedim\"");
                        log4jParamters_tDBOutput_2.append(" | ");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS="+("REPLACE")+", REFCOL="+("timekey")+", NAME="+("\"timekey\"")+", SQL="+("\"nextval('timedim_timekey_sequence')\"")+"}]");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("timedim");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("timedim");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "timekey" + "\",\"timestamp\") VALUES (" + "nextval('timedim_timekey_sequence')" + ",?)";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_1{
                    ...
                    log4jParamters_tUniqRow_1.append("Parameters:");
                            log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("timekey")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("timestamp")+"}]");
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.timestamp = row1.timestamp  == null ? null : new java.util.Date(row1.timestamp .getTime());
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.timestamp = '" + row2HashKey.timestamp + "'");
								} // G 071
...
Found1_tmp.timekey = row2.timekey ;
Found1_tmp.timestamp = row2.timestamp ;
Found1 = Found1_tmp;
...
NotFound1_tmp.timekey = 0;
NotFound1_tmp.timestamp = row1.timestamp ;
...
row4 = null;			
finder_tUniqRow_2.timekey = Found1.timekey;
finder_tUniqRow_2.timestamp = Found1.timestamp;	
finder_tUniqRow_2.hashCodeDirty = true;
if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
		KeyStruct_tUniqRow_2 new_tUniqRow_2 = new KeyStruct_tUniqRow_2();

		
new_tUniqRow_2.timekey = Found1.timekey;
new_tUniqRow_2.timestamp = Found1.timestamp;
	...
	row4 = new row4Struct();
}row4.timekey = Found1.timekey;			row4.timestamp = Found1.timestamp;					
...
pstmt_tDBOutput_1.setTimestamp(1, new java.sql.Timestamp(row4.timestamp.getTime()));
} else {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_1.setInt(2 + count_tDBOutput_1, row4.timekey);
...
row3 = null;			
finder_tUniqRow_1.timekey = NotFound1.timekey;
finder_tUniqRow_1.timestamp = NotFound1.timestamp;	
finder_tUniqRow_1.hashCodeDirty = true;
if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
		KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

		
new_tUniqRow_1.timekey = NotFound1.timekey;
new_tUniqRow_1.timestamp = NotFound1.timestamp;
	...
	row3 = new row3Struct();
}row3.timekey = NotFound1.timekey;			row3.timestamp = NotFound1.timestamp;					
...
if(row3 != null) { 
	...
	currentComponent="tDBOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tUniqRow_1","tUniqRow_1","tUniqRow","tDBOutput_2","__TABLE__","tPostgresqlOutput"
...
pstmt_tDBOutput_2.setTimestamp(1, new java.sql.Timestamp(row3.timestamp.getTime()));
} else {
		...
		int tos_count_tAdvancedHash_row2 = 0;
			...
			if(enableLogStash) {
				...
				talendJobLogProcess(globalMap);
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(Found1,NotFound1)
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT * FROM TIMEDIM;\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("timekey")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("timestamp")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
		    ...
		    String dbquery_tDBInput_2 = "SELECT * FROM TIMEDIM;";
            ...
            row2.timekey = rs_tDBInput_2.getInt(1);
			...
			row2.timestamp = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 2);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
				...
				row2_HashRow.timestamp = row2.timestamp;
 ...
 */
    ...
    public static void main(String[] args){
        final TimeDim TimeDimClass = new TimeDim();

        int exitCode = TimeDimClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'TimeDim' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'TimeDim' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = TimeDim.class.getClassLoader().getResourceAsStream("artistloc/timedim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TimeDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TimeDim");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     172876 characters generated by Talend Real-time Big Data Platform 
 *     on the November 15, 2024 at 1:49:20 PM EST
 ************************************************************************************************/