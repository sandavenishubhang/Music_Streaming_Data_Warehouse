...
package artistloc.artistoc_0_1;
...
/**
 * Job: Artistoc Purpose: To migrate Artists and loc<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Artistoc implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Artistoc.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Artistoc.class);
	...
	private final String jobName = "Artistoc";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Artistoc.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:R9KcMzPsxR4zmp/pYAUrqXSqu85QU741L0UtvcmG9eKU")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:YOWbzFZyx3nMA4gIt0JkN2Ecmt8zDdfrgYcQhGwAuKeU");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:LRdkjB/hUQzF32XQtXcTy3RJQ/rQVcUHcgzaMl8WO2WN")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_2.append(" | ");
				...
				final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:XJsxnQ4Q8CK+B9tmnD5bYGKtRCqgDKqgGprIzLHQpOLR");
	...
	public static class Found1Struct implements routines.system.IPersistableRow<Found1Struct> {
		final static byte[] commonByteArrayLock_ARTISTLOC_Artistoc = new byte[0];
		static byte[] commonByteArray_ARTISTLOC_Artistoc = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ARTISTLOC_Artistoc.length) {
					if (length < 1024 && commonByteArray_ARTISTLOC_Artistoc.length == 0) {
						commonByteArray_ARTISTLOC_Artistoc = new byte[1024];
					} else {
						commonByteArray_ARTISTLOC_Artistoc = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ARTISTLOC_Artistoc, 0, length);
				strReturn = new String(commonByteArray_ARTISTLOC_Artistoc, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_ARTISTLOC_Artistoc, 0, length);
				strReturn = new String(commonByteArray_ARTISTLOC_Artistoc, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ARTISTLOC_Artistoc) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append("ADD_COLS" + " = " + "[{POS=" + ("REPLACE") + ", REFCOL="
									+ ("countrykey") + ", NAME=" + ("\"countrykey\"") + ", SQL="
									+ ("\"nextval('countrydim_countrykey_sequence')\"") + "}]");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "countrykey"
						+ "\",\"country\") VALUES (" + "nextval('countrydim_countrykey_sequence')" + ",?)";
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1
									.append("QUERY" + " = " + "\"SELECT DISTINCT COUNTRY FROM ARTISTS\"");
							log4jParamters_tDBInput_1.append(" | ");
...
// # Output table : 'Found1'
								...
								Found1 = Found1_tmp;
								log.debug("tMap_2 - Outputting the record " + count_Found1_tMap_2
...
// # Filter conditions 
							if (rejectedInnerJoin_tMap_2) {
								...
								log.debug("tMap_2 - Outputting the record " + count_NotFound1_tMap_2
...
// Start of branch "Found1"
						if (Found1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "Found1", "tMap_2", "tMap_2", "tMap", "tDBOutput_1", "__TABLE__",
									"tPostgresqlOutput"
							...
							if (Found1.country == null) {
								...
								pstmt_tDBOutput_1.setString(1, Found1.country);
							}
...
// Start of branch "NotFound1"
						if (NotFound1 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "NotFound1", "tMap_2", "tMap_2", "tMap", "tDBOutput_2", "__TABLE__",
									"tPostgresqlOutput"
							...
							if (NotFound1.country == null) {
								...
								pstmt_tDBOutput_2.setString(1, NotFound1.country);
							}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "Found1", 2, 0, "tMap_2",
						"tMap_2", "tMap", "tDBOutput_1", "__TABLE__", "tPostgresqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2
									.append("QUERY" + " = " + "\"SELECT  CountryKey,Country FROM countrydim\"");
							log4jParamters_tDBInput_2.append(" | ");
							...
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append(
									"TRIM_COLUMN" + " = " + "[{TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("countrykey")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("country") + "}]");
							log4jParamters_tDBInput_2.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "tDBInput_2", "tPostgresqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "tDBInput_2", "tPostgresqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public static void main(String[] args) {
		final Artistoc ArtistocClass = new Artistoc();

		int exitCode = ArtistocClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Artistoc' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Artistoc' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Artistoc.class.getClassLoader()
					.getResourceAsStream("artistloc/artistoc_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Artistoc.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Artistoc");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 141608 characters generated by Talend Real-time Big Data Platform on the
 * November 7, 2024 at 4:52:13 PM EST
 ************************************************************************************************/